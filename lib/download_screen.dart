...
class _DownloadScreenState extends State<DownloadScreen> {
  ...
  VideoInfo currentVideoInfo= VideoInfo();
  double? progress = 0.0;
  bool stop=false;
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (newFormat) {
                      setState(() {
                        currentVideoInfo.format=newFormat!;
                      });
  ...
  Future<void> getInfo(String url) async {
    ...
    if (url.contains("list")) {
      ...
      await for (Video v in vv) {
        currentVideoInfo.video = v;
        var aa=VideoInfo();
        aa.video=v;
        aa.format=currentVideoInfo.format.toString();
  ...
  Future<void> downloadVideos() async {
    ...
    if (permisson.isGranted) {
      ...
      while(videosInfo.isNotEmpty){
        ...
        while(true){
          fileNameAndDirectory='$path/${video.title}${copyNumber==0?"":copyNumber}$format';
